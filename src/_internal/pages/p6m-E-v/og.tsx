...
import { defaultRenderOptions } from "@/_internal/lib/p6m-E/defaultRenderOptions";
import { renderToSvg } from "@/_internal/lib/p6m-E/renderToSvg";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          p6m E vertex<div style={{ padding: 24 }}>{name}</div>
          <div
            style={{
              display: "flex",
              gap: 12,
