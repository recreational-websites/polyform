...
// import { Editor } from "../../components/E-e/Editor";
...
import { directions } from "@/_internal/lib/E/e/directions";
...
import { encode } from "../../lib/E/e/encode";
import { moreInfo } from "../../lib/E/e/moreInfo";
import { SymmetryGroup } from "../../lib/E/SymmetryGroup";
...
function RelatedInternal({ moreInfo, onItemClick }: RelatedProps) {
  ...
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle>Related E edge items</CardTitle>
      </CardHeader>
      <CardContent>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">E edge {info[1]}</h2>
        <Button
          variant="ghost"
          size="icon"
          onClick={onClose}
  ...
  return (
    ...
    >
      <div className="desktop:flex-1">
        <Card>
          <CardHeader>
            <h1 className="text-3xl font-bold">E edge {coords[1]}</h1>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center">
              <Item
