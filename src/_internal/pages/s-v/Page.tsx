...
import { Editor } from "../../components/s-v/Editor";
...
function RelatedInternal({ moreInfo, onItemClick }: RelatedProps) {
  ...
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle>Related s vertex items</CardTitle>
      </CardHeader>
      <CardContent>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">s vertex {info[1]}</h2>
        <Button
          variant="ghost"
          size="icon"
          onClick={onClose}
  ...
  return (
    ...
    >
      <div className="desktop:flex-1">
        <Card>
          <CardHeader>
            <h1 className="text-3xl font-bold">s vertex {coords[1]}</h1>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center">
              <Item
