...
import { Comment } from "../../components/p6m-E-e/Comment";
// import { Editor } from "../../components/p6m-E-e/Editor";
import { Item } from "../../components/p6m-E-e/Item";
import { Coord } from "../../lib/common/Coord";
import { Info } from "../../lib/common/Info";
import { on } from "../../lib/on";
import { encode } from "../../lib/p6m-E/e/encode";
import { moreInfo } from "../../lib/p6m-E/e/moreInfo";
import { related } from "../../lib/p6m-E/e/related";
...
function RelatedInternal({ moreInfo, onItemClick }: RelatedProps) {
  ...
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle>Related p6m E edge items</CardTitle>
      </CardHeader>
      <CardContent>
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold">p6m E edge {info[1]}</h2>
        <Button
          variant="ghost"
          size="icon"
          onClick={onClose}
      ...
      <Link href={`/p6m-E-e/${encode(info[0])}`}>
  ...
  return (
    ...
    >
      <div className="desktop:flex-1">
        <Card>
          <CardHeader>
            <h1 className="text-3xl font-bold">p6m E edge {coords[1]}</h1>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col items-center">
