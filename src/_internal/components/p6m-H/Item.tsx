...
import { defaultRenderOptions } from "../../lib/p6m-H/defaultRenderOptions";
import { renderToSvg, RenderToSvgOptions } from "../../lib/p6m-H/renderToSvg";
